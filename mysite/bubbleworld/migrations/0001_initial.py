    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_permission', models.BooleanField(default=False)),
                ('modify_permission', models.BooleanField(default=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_response', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='last_responce', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': '主题帖',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_postpart', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='child_postpart', to='bubbleworld.PostPart')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='创建时间')),
                ('permissions', models.ManyToManyField(blank=True, related_name='permissions', to='bubbleworld.Permission')),
            ],
            options={
                'verbose_name': '用户组',
        ...
        migrations.AddField(
            model_name='user',
            name='groups',
            field=models.ManyToManyField(blank=True, related_name='groups', to='bubbleworld.Group'),
        ),
        migrations.AddField(
            model_name='user',
